%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% File: boss_news_app.erl
%% Date: 15/05/2012
%%
%% @doc OTP application for boss_news
%%
...
start(_StartType, _StartArgs) ->
    {ok, Keys} = application:get_env(boss_news_params),
    boss_news:start(Keys). % TODO: if sharding is used, this will not return correct pid
